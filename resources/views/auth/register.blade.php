            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tell" class="col-md-4 col-form-label text-md-right">{{ __('شماره تلفن') }}</label>

                            <div class="col-md-6">
                                <input id="tell" type="tell" class="form-control{{ $errors->has('tell') ? ' is-invalid' : '' }}" name="tell" value="{{ old('tell') }}" required>

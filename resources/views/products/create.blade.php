...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('افزودن محصول جدید') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="IDproduct" type="text" class="form-control{{ $errors->has('IDproduct') ? ' is-invalid' : '' }}" name="IDproduct" value="{{ old('IDproduct') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subcategory_id" type="text" class="form-control" name="subcategory_id" required>
                            </div>
                        </div>
